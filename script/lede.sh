...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='JCWRT'' package/lean/default-settings/files/zzz-default-settings
...
echo -e " Jackie's JCWRT built on "$(date +%Y.%m.%d)"\n -----------------------------------------------------" >> package/base-files/files/etc/banner
